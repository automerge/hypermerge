...
export declare function isDocUrl(str: string): str is DocUrl;
export declare function withoutQuery(url: DocUrl): DocUrl;
export declare function withoutQuery(url: HyperfileUrl): HyperfileUrl;
export declare function withoutQuery(url: BaseUrl): BaseUrl;
