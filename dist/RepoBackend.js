    ...
    constructor(opts) {
        ...
        this.close = () => {
            ...
            return Promise.all([
                ...
                var _a;
                (_a = this.lockRelease) === null || _a === void 0 ? void 0 : _a.call(this);
            });
        };
        ...
        this.handleQuery = (id, query) => __awaiter(this, void 0, void 0, function* () {
            switch (query.type) {
                ...
                case 'VerifyMsg': {
                    let success;
                    try {
                        const signedMessage = Object.assign(Object.assign({}, query.signedMessage), { message: Buffer.from(query.signedMessage.message) });
