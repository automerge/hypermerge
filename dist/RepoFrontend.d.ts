...
export declare class RepoFrontend {
    ...
    watch: <T>(url: DocUrl, cb: (val: T, clock?: Clock | undefined, index?: number | undefined) => void) => Handle<T>;
    message: (url: DocUrl, contents: any) => void;
    doc: <T>(url: DocUrl, cb?: ((val: T, clock?: Clock | undefined) => void) | undefined) => Promise<T>;
    materialize: <T>(url: DocUrl, history: number, cb: (val: T) => void) => void;
